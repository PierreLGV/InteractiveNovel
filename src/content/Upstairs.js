...
import image from '../images/forestruins.jpg'
...
export const choices = [
  { page: 'HuntingTrap', message: '1. Set a trap' },
  { page: 'ForestLichen', message: '3. Look for animal tracks'},
  { page: 'Bandit', message: '4. Go deeper in the woods'},
]
